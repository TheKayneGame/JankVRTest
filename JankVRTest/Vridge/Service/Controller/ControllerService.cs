...
namespace JankVRTest.Service.Controller
{
    class ControllerService : IDisposable
    {
        ...
        private VRController[] controllerState = new VRController[2];
        ...
        public ControllerService(ControllerProxy proxy)
        {
            ...
            // Set initial state
                ...
                SetControllerState(0, HandType.Left, 0, 0, 0, 0, 0, 0, 0, 0, 0, false, false, false);
                SetControllerState(1, HandType.Right, 0, 0, 0, 0, 0, 0, 0, 0, 0, false, false, false);
            ...
            bool isTriggerPressed)
        {
            ...
            controllerState[controllerId] = new VRController()
            {
                ButtonState = buttons,
                Status = 0,
        ...
        private void StateSendingLoop()
        {
            try
            {
                while (isActive)
                {
                    foreach(VRController controller in controllerState)
                    {
